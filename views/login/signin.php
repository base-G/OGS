...
<title>FITkids - Sign In</title>
  ...
  width:900px;
  min-height: 300px; /*can be anything, just should make sure it is taller than the sidebar*/
  padding: 25px;
...
<h1 >
Welcome to FITkids! Please <strong style="color:#8CC63F">SIGN IN</strong>.
...
<div class="wrap" style="width:1100px; margin-top:50px;">
 ...
 <div style="border-right:1px solid #bbb; float:left;  width:500px; height:290px;">
...
<tr>
<td><br><br><br><br><br><input type="submit" name="login" value="Sign In"> </td>
</tr>
</table>
...
<div style="float:right; width:350px;  ">
  ...
  <a class="sidebutton" style="margin: 0 auto; margin-top:50px" href="process.php?action=register">Sign Up</a>
  <p style="margin-top:25px;">Sign up to gain access to FITkids. Joining FITkids is a major step towards making your community healthier!</p>
