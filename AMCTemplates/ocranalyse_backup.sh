...
# analyse
auto-multiple-choice analyse --multiple --tol-marque 0.2,0.2 --prop 0.8 --bw-threshold 0.5 --progression-id analyse --progression 1 --n-procs 0 --data /var/www/tmp/baseg$2/data --projet /tmp/baseg$2/ --cr /var/www/tmp/baseg$2/cr --list /var/www/tmp/$2.list --no-ignore-red --pre-allocate 1
